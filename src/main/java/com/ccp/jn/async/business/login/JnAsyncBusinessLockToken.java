...
public class JnAsyncBusinessLockToken implements Function<CcpJsonRepresentation, CcpJsonRepresentation> {
	...
	public CcpJsonRepresentation apply(CcpJsonRepresentation json) {
		...
		TransferRecordToReverseEntity registerLock = new TransferRecordToReverseEntity(JnEntityLoginToken.INSTANCE, CcpConstants.DO_NOTHING, CcpConstants.DO_NOTHING);
